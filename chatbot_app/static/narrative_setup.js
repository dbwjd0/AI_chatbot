...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const script = [
        ...
        { speaker: '{ai_name}', text: '마지막으로, 내가 어떤 스타일로 대화하면 좋을지 알려줄래?' },
        { speaker: '{ai_name}', text: '예시: 친근한, 유머러스한, 전문적인, 다정한, 시크한' },
        { action: 'show_input', type: 'text', fact_type: 'chatbot_style', warning: '*챗봇의 대화 스타일을 한 단어로 입력해주세요.*' },
        { speaker: '{ai_name}', text: '좋아! 그럼 이제부터 {chatbot_style} 스타일로 너와 대화할게.' },
